...
return [
    ...
    'text_greeting_1' => '我們將指引您對系統做一些基本的自訂配置，幫助您瞭解BeikeShop系統功能，快速開始使用！ ',
    'text_basic_1'    => '首先，您可在系統設定中配置以下重要資訊：',
    'text_language_1' => 'BeikeShop 系統支援多語言、多貨幣，在開始建立您的第一個商品前，可以先選擇商城前臺預設的語言和貨幣！ ',
    ...
    'text_product_2'  => 'BeikeShop 提供了強大的商品管理能力！ 包括:<a href="' . admin_route('categories.index') . '">商品分類</a>，<a href="' . admin_route('brands.index') . '">品牌管理</a>，多規格商品，<a href="' . admin_route('multi_filter.index') . '">高階篩選</a>，<a href="' . admin_route('attributes.index') . '">商品屬性</a>等功能。 ',
    ...
    'text_payment_4'  => '您也可以去BeikeShop<a href="' . admin_route('marketing.index') . '">「外掛市場」</a>瞭解並下載更多的收款方式、物流方式 ！ ',
