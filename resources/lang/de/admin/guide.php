...
return [
    ...
    'text_greeting'   => 'Herzlichen Glückwunsch, Ihre Website hat US3C erfolgreich installiert! ',
    'text_greeting_1' => 'Wir werden Sie dabei unterstützen, einige grundlegende benutzerdefinierte Konfigurationen am System vorzunehmen, damit Sie die Funktionen des US3C-Systems verstehen und schnell mit der Nutzung beginnen können! ',
    'text_basic_1'    => 'Zunächst können Sie in den Systemeinstellungen folgende wichtige Informationen konfigurieren:',
    'text_sprache_1'  => 'Das US3C-System unterstützt mehrere Sprachen und Währungen. Bevor Sie mit der Erstellung Ihres ersten Produkts beginnen, können Sie an der Rezeption des Einkaufszentrums die Standardsprache und -währung auswählen! ',
    ...
    'text_zahlung_1'  => 'US3C bietet häufig verwendete Zahlungskanäle im Ausland, wie z. B. das Standard-PayPal, Stripe usw. Bevor Sie offiziell eine Bestellung aufgeben, müssen Sie die entsprechende Zahlungsmethode aktivieren und konfigurieren. ',
    ...
    'text_zahlung_4'  => 'Sie können auch zu US3C<a href="' . admin_route('marketing.index') . '">"Plug-in Market"</a> gehen, um mehr Zahlungsmethoden und Logistik zu erfahren und herunterzuladen Methoden! ',
