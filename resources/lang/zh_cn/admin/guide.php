...
return [
    ...
    'text_edit'                    => '编辑新手引导',
    'text_view'                    => '显示详细...',
    'text_greeting'                => '恭喜，您的网站已成功安装US3C！',
    'text_greeting_1'              => '我们将指引您对系统做一些基本的自定义配置，帮助您了解US3C系统功能，快速开始使用！',
    'text_basic_1'                 => '首先，您可在系统设置中配置以下重要信息：',
    'text_language_1'              => 'US3C 系统支持多语言、多货币，在开始创建您的第一个商品前，可以先选择商城前台默认的语言和货币！',
    ...
    'text_product_2'               => 'US3C 提供了强大的商品管理能力！包括:<a href="' . admin_route('categories.index') . '">商品分类</a>，<a href="' . admin_route('brands.index') . '">品牌管理</a>，多规格商品，<a href="' . admin_route('multi_filter.index') . '">高级筛选</a>，<a href="' . admin_route('attributes.index') . '">商品属性</a>等功能。',
    ...
    'text_payment_1'               => 'US3C 提供了海外常用的收款渠道，如默认的 PayPal、Stripe 等。在正式开放下单前，您需要启用并配置相应收款方式。',
    'text_payment_2'               => '注意：某些支付接口申请审核时间较长，请提前申请。在国内使用的支付方式可能会要求网站域名备案。',
    'text_payment_3'               => '此外，您还需要设置物流配送方式供顾客选择。系统免费提供了固定运费插件。',
    'text_payment_4'               => '您还可以去US3C<a href="' . admin_route('marketing.index') . '">“插件市场”</a>了解并下载更多的收款方式、物流方式！',
    'text_mail_1'                  => '邮件通知可以让您的客户及时了解订单状态，同时也可通过邮件注册和找回密码。',
    'text_mail_2'                  => '您可按实际业务需求配置 SMTP，Sendmail 等邮件引擎用于发送邮件。',
