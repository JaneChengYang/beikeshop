...
return [
    ...
    'text_view'       => '세부정보 표시...',
    'text_greeting'   => '축하합니다. 귀하의 웹사이트에 US3C이 성공적으로 설치되었습니다! ',
    'text_greeting_1' => 'US3C 시스템의 기능을 이해하고 빠르게 사용할 수 있도록 시스템에서 몇 가지 기본 사용자 정의 구성을 안내해 드리겠습니다! ',
    'text_basic_1'    => '먼저 시스템 설정에서 다음과 같은 중요한 정보를 구성할 수 있습니다:',
    'text_언어_1'       => 'US3C 시스템은 다양한 언어와 통화를 지원합니다. 첫 번째 제품 제작을 시작하기 전에 쇼핑몰 프론트 데스크에서 기본 언어와 통화를 선택할 수 있습니다! ',
    ...
    'text_product_2'  => 'US3C은 강력한 제품 관리 기능을 제공합니다! 포함: <a href="' . admin_route('categories.index') . '">제품 분류</a>, <a href="' . admin_route('brands.index') . '">브랜드 관리</a>, 다중 사양 제품, <a href="' . admin_route('multi_filter.index') . '">고급 필터링</a>, <a href="' . admin_route('attributes.index') . '">제품 속성</a> 및 기타 기능. ',
    ...
    'text_pay_1'      => 'US3C은 기본 PayPal, Stripe 등 일반적으로 사용되는 해외 결제 채널을 제공합니다. 공식적으로 주문하기 전에 해당 결제 방법을 활성화하고 구성해야 합니다. ',
    ...
    'text_pay_4'      => 'US3C<a href="' . admin_route('marketing.index') . '">"플러그인 마켓"</a>으로 이동하여 더 많은 결제 방법과 실행 방법을 알아보고 다운로드할 수도 있습니다. 방법! ',
    'text_mail_1'     => '이메일 알림을 통해 고객에게 주문 상태를 계속 알릴 수 있으며 이메일을 통해 비밀번호를 등록하고 검색할 수도 있습니다. ',
    'text_mail_2'     => '실제 비즈니스 요구에 따라 SMTP를 구성할 수 있으며 Sendmail와 같은 이메일 엔진을 사용하여 이메일을 보냅니다. ',
