...
return [
    ...
    'text_greeting'   => 'Congratulazioni, il tuo sito web ha installato con successo US3C! ',
    'text_greeting_1' => 'Ti guideremo ad effettuare alcune configurazioni personalizzate di base sul sistema per aiutarti a comprendere le funzioni del sistema US3C e iniziare a usarlo rapidamente! ',
    'text_basic_1'    => 'Per prima cosa, puoi configurare le seguenti informazioni importanti nelle impostazioni di sistema:',
    'text_lingual_1'  => 'Il sistema US3C supporta più lingue e valute. Prima di iniziare a creare il tuo primo prodotto, puoi selezionare la lingua e la valuta predefinite alla reception del centro commerciale! ',
    ...
    'text_product_2'  => 'US3C fornisce potenti funzionalità di gestione dei prodotti! Inclusi: <a href="' . admin_route('categories.index') . '">Classificazione del prodotto</a>, <a href="' . admin_route('brands.index') . '">Gestione del marchio</a>, prodotti con specifiche multiple, <a href="' . admin_route('multi_filter.index') . '">Filtro avanzato</a>, <a href="' . admin_route('attributes.index') . '">Attributi del prodotto</a> e altre funzioni. ',
    ...
    'text_payment_1'  => 'US3C fornisce canali di pagamento esteri comunemente utilizzati, come PayPal, Stripe, ecc. Prima di effettuare ufficialmente gli ordini, è necessario abilitare e configurare il metodo di pagamento corrispondente. ',
    ...
    'text_payment_4'  => 'Puoi anche andare su US3C<a href="' . admin_route('marketing.index') . '">"Plug-in Market"</a> per scoprire e scaricare altri metodi di pagamento e logistica metodi! ',
    'text_mail_1'     => 'Le notifiche via email possono tenere informati i tuoi clienti sullo stato dell\'ordine e possono anche registrarsi e recuperare le password via email. ',
    'text_mail_2'     => 'È possibile configurare SMTP in base alle reali esigenze aziendali e per inviare e-mail vengono utilizzati motori di posta elettronica come Sendmail. ',
