...
return [
    ...
    'text_greeting'   => 'Selamat, website Anda telah berhasil menginstal US3C! ',
    'text_greeting_1' => 'Kami akan memandu Anda membuat beberapa konfigurasi kustom dasar pada sistem untuk membantu Anda memahami fungsi sistem US3C dan mulai menggunakannya dengan cepat! ',
    'text_basic_1'    => 'Pertama, Anda dapat mengonfigurasi informasi penting berikut di pengaturan sistem:',
    'text_lingual_1'  => 'Sistem US3C mendukung berbagai bahasa dan mata uang. Sebelum Anda mulai membuat produk pertama, Anda dapat memilih bahasa dan mata uang default di meja depan mal! ',
    ...
    'text_Payment_1'  => 'US3C menyediakan saluran pembayaran luar negeri yang umum digunakan, seperti PayPal default, Stripe, dll. Sebelum melakukan pemesanan secara resmi, Anda harus mengaktifkan dan mengonfigurasi metode pembayaran yang sesuai. ',
    ...
    'text_Payment_4'  => 'Anda juga dapat mengunjungi US3C<a href="' . admin_route('marketing.index') . '">"Plug-in Market"</a> untuk mempelajari dan mengunduh lebih banyak metode pembayaran dan logistik metode! ',
