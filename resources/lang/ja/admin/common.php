...
return [
    ...
    'copyright_hint_text' => '下部にある著作権を保持するか、ライセンスを購入してください。 購入済みの場合は、<a href="#" class="get-license-code">クリックして承認</a>してください',
    ...
    'update_title'                 => 'US3C の新しいバージョンを見つけて、今すぐ更新するかどうか',
    'zone'                         => '地方管理',
    'zones_index'                  => '州管理',
    'help_index'                   => 'ヘルプ',
