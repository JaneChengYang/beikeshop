...
return [
    ...
    'text_view'        => '詳細を表示...',
    'text_greeting'    => 'おめでとうございます。あなたのウェブサイトに US3C が正常にインストールされました。 ',
    'text_greeting_1'  => 'US3C システムの機能を理解し、すぐに使い始めることができるように、システム上でいくつかの基本的なカスタム構成を作成する方法を説明します。 ',
    'text_basic_1'     => 'まず、システム設定で次の重要な情報を構成できます:',
    'text_ language_1' => 'US3C システムは複数の言語と通貨をサポートしています。最初の商品の作成を開始する前に、モールのフロント デスクでデフォルトの言語と通貨を選択できます。 ',
    ...
    'text_product_2'   => 'US3C は強力な製品管理機能を提供します。 含まれるもの: <a href="' . admin_route('categories.index') . '">商品分類</a>、<a href="' . admin_route('brands.index') . '">ブランド管理</a>、複数仕様の製品、<a href="' . admin_route('multi_filter.index') . '">高度なフィルタリング</a>、<a href="' . admin_route('attributes.index') . '">製品属性</a>およびその他の機能。 ',
    ...
    'text_payment_1'   => 'US3C は、デフォルトの PayPal、Stripe など、一般的に使用される海外の支払いチャネルを提供します。 正式に注文する前に、対応する支払い方法を有効にして設定する必要があります。 ',
    ...
    'text_payment_4'   => 'US3C<a href="' . admin_route('marketing.index') . '">「プラグイン マーケット」</a> にアクセスして、その他の支払い方法とロジスティクスを確認およびダウンロードすることもできます。メソッド！ ',
    'text_mail_1'      => '電子メール通知により、顧客は注文ステータスを常に知ることができ、電子メール経由でパスワードを登録および取得することもできます。 ',
    'text_mail_2'      => '実際のビジネス ニーズに応じて SMTP を構成でき、電子メールの送信には Sendmail などの電子メール エンジンが使用されます。 ',
