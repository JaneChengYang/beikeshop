...
return [
    ...
    'bk_login_hint'           => 'Log in with <a href="' . beike_url() . '/account" target="_blank">beikeshop.com</a> account',
    'bk_register_hint'        => 'Register a new account with <a href="' . beike_url() . '/account" target="_blank">beikeshop.com</a>',
    'btn_buy'                 => 'Buy',
