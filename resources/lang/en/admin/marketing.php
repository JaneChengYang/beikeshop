...
return [
    ...
    'bind_bk_token'           => 'Bind US3C account and get Token automatically',
    'bk_login_hint'           => 'Log in with beikeshop.com account',
    ...
    'get_token'               => 'Get Token',
    'get_token_text'          => 'Log in to US3C official website personal center - bind domain name, add current domain name',
    ...
    'domain_token_domain_error' => 'The current domain name: :domain is inconsistent with the domain name bound to the Token: :token_domain. Please confirm before purchasing, or rebind the Token. View the tutorial',
