    ...
    ->group(function () {
        ...
        Route::middleware('checkout_auth:' . Customer::AUTH_GUARD)
            ->group(function () {
                ...
                Route::post('checkout/coupon', [\Beike\Shop\Http\Controllers\CouponController::class, 'apply'])->name('checkout.coupon.apply');
                Route::delete('checkout/coupon', [\Beike\Shop\Http\Controllers\CouponController::class, 'remove'])->name('checkout.coupon.remove');
